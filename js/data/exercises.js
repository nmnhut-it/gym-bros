...
export const EXERCISES = Object.freeze({
  ...
  'side-plank-knee': EX({
    ...
    instructions: 'Nằm nghiêng, chống khuỷu tay (vai thẳng trên khuỷu), gối co lại. Hóp bụng nhẹ (rốn về cột sống). Nâng hông lên thành đường thẳng từ đầu đến gối. Giữ, thở đều. Đổi bên giữa các set.',
    cues: ['Rốn về cột sống', 'Hông cao', 'Thở đều'],
  ...
  'plank-knee': EX({
    ...
    instructions: 'Quỳ gối, chống khuỷu tay xuống sàn (khuỷu dưới vai). Người tạo đường thẳng từ vai đến gối. Hóp bụng nhẹ (rốn về cột sống), siết bụng và mông, đừng để hông xệ. Thở đều — không nín thở.',
    cues: ['Rốn về cột sống', 'Hông không xệ', 'Thở đều'],
    equipment: [E.YOGA_MAT], calsPerMin: 4,
  ...
  'glute-bridge': EX({
    ...
    defaultSets: 3, defaultReps: 15, defaultRest: 30,
    instructions: 'Nằm ngửa, gối co, bàn chân sát mông. Hóp bụng nhẹ (rốn về cột sống). Siết mông đẩy hông lên, vai-hông-gối thành đường thẳng. Thở ra khi đẩy lên. Giữ 1 giây trên đỉnh, hạ xuống nhẹ nhàng.',
    cues: ['Rốn về cột sống', 'Siết mông trên đỉnh', 'Thở ra khi đẩy', 'Đừng ưỡn lưng'],
    equipment: [E.YOGA_MAT], calsPerMin: 3,
    safetyTags: [C.CORE_EASY, C.CORE_MIN, C.BACK_EASY],
  }),
  ...
  'reverse-lunge': EX({
    ...
    instructions: 'Đứng thẳng, bước CHÂN PHẢI lùi ra sau, hạ gối phải gần chạm sàn. Đẩy gót chân trái lên về tư thế ban đầu. Đổi bên. Lùi sau dễ hơn cho gối so với lunge tới trước. Thở ra khi đẩy gót lên.',
    cues: ['Gối trước thẳng góc', 'Thân thẳng', 'Thở ra khi đẩy lên'],
    equipment: [], calsPerMin: 5,
    safetyTags: [C.CORE_EASY],
  ...
  'wall-sit': EX({
    ...
    defaultSets: 3, defaultDuration: 30, defaultRest: 60,
    instructions: 'Tựa lưng vào tường, trượt xuống đến khi đùi song song sàn (như ngồi ghế tưởng tượng). Gối thẳng góc 90°. Hóp bụng nhẹ. Giữ — thở đều, không nín thở rặn.',
    cues: ['Đùi song song sàn', 'Hóp bụng nhẹ', 'Thở đều', 'Đừng nín thở'],
  ...
  'wall-pushup': EX({
    ...
    cues: ['Người thẳng', 'Thở ra khi đẩy', 'Không nín thở'],
    equipment: [], calsPerMin: 4,
    safetyTags: [C.CORE_EASY, C.CORE_MIN],
  }),
  'knee-pushup': EX({
  ...
  'shoulder-tap': EX({
    ...
    instructions: 'Tư thế plank cao chống tay (hoặc plank gối). Tay phải chạm vai trái rồi đổi bên. Giữ hông không xoay. Thở đều — không nín thở.',
    cues: ['Hông không xoay', 'Siết bụng', 'Thở đều'],
    equipment: [E.YOGA_MAT], calsPerMin: 5,
    safetyTags: [C.CORE_EASY],
    unsafeFor: [C.CORE_MIN],
  }),
