...
export const EXERCISES = Object.freeze({
  ...
  'walk-warmup': EX({
    ...
    safetyTags: [C.HERNIA_HEALED, C.BACK_PAIN, C.KNEE_PAIN],
  }),
  'walk-zone2': EX({
  ...
  'dead-bug': EX({
    ...
    safetyTags: [C.HERNIA_HEALED, C.HERNIA_ACUTE, C.BACK_PAIN],
  }),
  'bird-dog': EX({
  ...
  'plank-knee': EX({
    ...
    equipment: [E.YOGA_MAT], calsPerMin: 4,
    safetyTags: [C.HERNIA_HEALED, C.BACK_PAIN],
  }),
  'glute-bridge': EX({
  ...
  'bw-squat': EX({
    ...
    instructions: 'Đứng rộng bằng vai, mũi chân hơi xoay ngoài. Hạ mông xuống như ngồi ghế, đến khi đùi gần song song sàn. Gối hướng theo mũi chân, KHÔNG lao về trước. Đẩy gót lên. THỞ ĐỀU, không nín thở.',
    cues: ['Mông đẩy ra sau', 'Gối theo mũi chân', 'Thở đều'],
    equipment: [], calsPerMin: 5,
    safetyTags: [C.HERNIA_HEALED],
    unsafeFor: [C.HERNIA_ACUTE, C.KNEE_PAIN],
  }),
  'reverse-lunge': EX({
  ...
  'standing-calf': EX({
    ...
    safetyTags: [C.HERNIA_HEALED, C.HERNIA_ACUTE],
  }),
  'wall-sit': EX({
  ...
  'shoulder-stretch': EX({
    ...
    safetyTags: [C.HERNIA_HEALED, C.HERNIA_ACUTE, C.BACK_PAIN, C.KNEE_PAIN],
  }),
});
